          ...
          <div class="x_panel">
              ...
              <div class="clearfix"></div>
           	...
           	<?php 
           		if (isset($_POST["submit"])) {
           			...
           			// die;
           			$stmt=$conn->prepare("UPDATE customer SET name=?, father_name=?,cnic=?,phone_no=?,address=? WHERE id=?");
            ...
            <div class="x_content">
             <form method="post">
              ...
              <div class="row">
              	<button required type="submit" class="btn btn-success" name="submit"><i class="fa fa-save"></i> Update customer</button>
              	<a href="index_customer.php" class="btn btn-danger" ><i class="fa fa-times"></i> Cancel</a>
