          ...
          <div class="x_panel">
              ...
              <div class="clearfix"></div>
           	...
           	<?php 
           		if (isset($_POST["submit"])) {
           			...
           			// die;
           			$stmt=$conn->prepare("INSERT INTO customer (name,father_name,cnic,phone_no,address) VALUES(?,?,?,?,?)");
            ...
            <div class="x_content">
             <form method="post">
              ...
              <div class="row">
              	<button required type="submit" class="btn btn-success" name="submit"><i class="fa fa-plus-square"></i> Add New Customer</button>
